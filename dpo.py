...
valid_dpo_losses = ["sigmoid", "hinge", "ipo", "exo_pair", "nca_pair", "robust", "bco_pair", "sppo_hard", "aot",
                    "aot_pair", "discopop", "apo_zero", "apo_down"]
# assert args.dpo_loss in valid_dpo_losses, "Supplied {args.dpo_loss} for DPO loss, but must be one of:\n {', '.join(valid_dpo_losses)}."
